...
class Man:
    ...
    def _validate_date(self, date):
        ...
        if date and isinstance(date, str) and formatted_date and self.today >= formatted_date:
    ...
    def get_age(self):
        ...
        age = self.today.year - self._date.year - ((self.today.month, self.today.day) < (self._date.month, self._date.day))
    ...
    def get_leap_year(self):
        ...
        for year in range(self._date.year, self.today.year):
